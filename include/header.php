...
<body>
    <header class="w-full h-screen header">
        ...
        <nav class="w-full h-30 flex justify-around">
            ...
            <div class="w-full p-5 text-xl texto flex justify-center gap-10">
        ...
        <h2 class="font-averta text-7xl uppercase font-bold mt-8 text-center">"Duerme bien, vive mejor."</h2>
